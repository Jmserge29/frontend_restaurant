...
function AddProfile({setOrder, order}) {
  ...
  return (
    ...
    <div className="rounded-xl hover:shadow-indigo-600 mx-2 py-4 shadow-2xl shadow-indigo-500/40  pt-4 bg-white">
      <div className='mx-8'>
        <input value={name} placeholder='Customer One' onChange={(e) => setName(e.target.value)} type="text" className=' text-2xl font-medium text-center w-full rounded-md py-1.5 text-gray-900 sm:leading-6'/>
      </div>
